...
public final class SpreadFloatsImpl {
    ...
    public interface SpreadFloatsService {
        static SpreadFloatsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz
                    = Class.forName("type.property.additionalproperties.implementation.SpreadFloatsServiceImpl");
                return (SpreadFloatsService) clazz
        ...
        Response<SpreadFloatRecord> get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default SpreadFloatRecord get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept) {
