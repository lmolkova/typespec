...
import type.property.optional.models.CollectionsModelProperty;
...
public final class CollectionsModelsImpl {
    ...
    CollectionsModelsImpl(OptionalClientImpl client) {
        this.service = RestProxy.create(CollectionsModelsService.class, client.getHttpPipeline());
        this.client = client;
    }
    ...
    public interface CollectionsModelsService {
        static CollectionsModelsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName("type.property.optional.implementation.CollectionsModelsServiceImpl");
                return (CollectionsModelsService) clazz
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default CollectionsModelProperty getAll(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default CollectionsModelProperty getDefault(@HostParam("endpoint") String endpoint,
            @HeaderParam("Accept") String accept) {
