...
public final class SpreadDifferentFloatsImpl {
    ...
    public interface SpreadDifferentFloatsService {
        static SpreadDifferentFloatsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class
                    .forName("type.property.additionalproperties.implementation.SpreadDifferentFloatsServiceImpl");
                return (SpreadDifferentFloatsService) clazz
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default DifferentSpreadFloatRecord get(@HostParam("endpoint") String endpoint,
