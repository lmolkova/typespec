...
import type.property.optional.models.IntLiteralProperty;
...
public final class IntLiteralsImpl {
    ...
    public interface IntLiteralsService {
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default IntLiteralProperty getAll(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default IntLiteralProperty getDefault(@HostParam("endpoint") String endpoint,
            @HeaderParam("Accept") String accept) {
