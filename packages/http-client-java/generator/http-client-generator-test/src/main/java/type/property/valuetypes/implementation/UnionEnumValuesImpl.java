...
import type.property.valuetypes.models.UnionEnumValueProperty;
...
public final class UnionEnumValuesImpl {
    ...
    public interface UnionEnumValuesService {
        static UnionEnumValuesService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName("type.property.valuetypes.implementation.UnionEnumValuesServiceImpl");
                return (UnionEnumValuesService) clazz
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default UnionEnumValueProperty get(@HostParam("endpoint") String endpoint,
