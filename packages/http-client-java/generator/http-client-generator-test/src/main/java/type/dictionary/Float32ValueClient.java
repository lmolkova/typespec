...
public final class Float32ValueClient {
     ...
     */
    @Metadata(generated = true)
    Float32ValueClient(Float32ValuesImpl serviceClient, Instrumentation instrumentation) {
    ...
    public Response<Map<String, Double>> getWithResponse(RequestOptions requestOptions) {
        return this.instrumentation.instrumentWithResponse("Type.Dictionary.Float32Value.get", requestOptions,
    ...
    public Response<Void> putWithResponse(BinaryData body, RequestOptions requestOptions) {
        return this.instrumentation.instrumentWithResponse("Type.Dictionary.Float32Value.put", requestOptions,
