...
public final class FloatOperationsImpl {
    ...
    public interface FloatOperationsService {
        static FloatOperationsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName("type.property.valuetypes.implementation.FloatOperationsServiceImpl");
                return (FloatOperationsService) clazz
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default FloatProperty get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept) {
