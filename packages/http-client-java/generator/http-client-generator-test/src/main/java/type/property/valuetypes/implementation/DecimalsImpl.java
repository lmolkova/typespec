...
public final class DecimalsImpl {
    ...
    DecimalsImpl(ValueTypesClientImpl client) {
        this.service = RestProxy.create(DecimalsService.class, client.getHttpPipeline());
        this.client = client;
    }
    ...
    public interface DecimalsService {
        static DecimalsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName("type.property.valuetypes.implementation.DecimalsServiceImpl");
                return (DecimalsService) clazz.getMethod("getNewInstance", HttpPipeline.class, ObjectSerializer.class)
        ...
        Response<DecimalProperty> get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default DecimalProperty get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept) {
     ...
     * @return call.
     */
    public Response<DecimalProperty> getWithResponse(RequestOptions requestOptions) {
