...
public final class UnknownsImpl {
    ...
    public interface UnknownsService {
        static UnknownsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName("type.scalar.implementation.UnknownsServiceImpl");
                return (UnknownsService) clazz.getMethod("getNewInstance", HttpPipeline.class, ObjectSerializer.class)
        ...
        @HttpRequestInformation(method = HttpMethod.GET, path = "/type/scalar/unknown", expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default BinaryData get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept) {
