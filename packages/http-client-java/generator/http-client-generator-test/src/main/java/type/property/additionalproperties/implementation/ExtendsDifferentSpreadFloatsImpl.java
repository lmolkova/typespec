...
public final class ExtendsDifferentSpreadFloatsImpl {
    ...
    public interface ExtendsDifferentSpreadFloatsService {
        static ExtendsDifferentSpreadFloatsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName(
                    "type.property.additionalproperties.implementation.ExtendsDifferentSpreadFloatsServiceImpl");
                return (ExtendsDifferentSpreadFloatsService) clazz
        ...
        Response<DifferentSpreadFloatDerived> get(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default DifferentSpreadFloatDerived get(@HostParam("endpoint") String endpoint,
