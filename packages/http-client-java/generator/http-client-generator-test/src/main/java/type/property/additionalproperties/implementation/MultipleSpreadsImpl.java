...
public final class MultipleSpreadsImpl {
    ...
    public interface MultipleSpreadsService {
        static MultipleSpreadsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz
                    = Class.forName("type.property.additionalproperties.implementation.MultipleSpreadsServiceImpl");
                return (MultipleSpreadsService) clazz
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default MultipleSpreadRecord get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept) {
