...
public final class StringOperationsImpl {
    ...
    public interface StringOperationsService {
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default StringProperty getAll(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept) {
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default StringProperty getDefault(@HostParam("endpoint") String endpoint,
