...
import type.property.optional.models.StringLiteralProperty;
...
public final class StringLiteralsImpl {
    ...
    public interface StringLiteralsService {
        static StringLiteralsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName("type.property.optional.implementation.StringLiteralsServiceImpl");
                return (StringLiteralsService) clazz
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default StringLiteralProperty getAll(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default StringLiteralProperty getDefault(@HostParam("endpoint") String endpoint,
            @HeaderParam("Accept") String accept) {
