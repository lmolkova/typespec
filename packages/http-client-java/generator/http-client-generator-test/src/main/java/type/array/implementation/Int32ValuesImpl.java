...
public final class Int32ValuesImpl {
    ...
    public interface Int32ValuesService {
        static Int32ValuesService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName("type.array.implementation.Int32ValuesServiceImpl");
                return (Int32ValuesService) clazz
