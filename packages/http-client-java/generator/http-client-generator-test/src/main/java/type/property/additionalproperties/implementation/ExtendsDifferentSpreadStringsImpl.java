...
public final class ExtendsDifferentSpreadStringsImpl {
    ...
    public interface ExtendsDifferentSpreadStringsService {
        static ExtendsDifferentSpreadStringsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName(
                    "type.property.additionalproperties.implementation.ExtendsDifferentSpreadStringsServiceImpl");
                return (ExtendsDifferentSpreadStringsService) clazz
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default DifferentSpreadStringDerived get(@HostParam("endpoint") String endpoint,
