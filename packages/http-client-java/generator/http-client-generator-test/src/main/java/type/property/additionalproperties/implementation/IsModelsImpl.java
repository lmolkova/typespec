...
public final class IsModelsImpl {
    ...
    public interface IsModelsService {
        static IsModelsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName("type.property.additionalproperties.implementation.IsModelsServiceImpl");
                return (IsModelsService) clazz.getMethod("getNewInstance", HttpPipeline.class, ObjectSerializer.class)
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default IsModelAdditionalProperties get(@HostParam("endpoint") String endpoint,
