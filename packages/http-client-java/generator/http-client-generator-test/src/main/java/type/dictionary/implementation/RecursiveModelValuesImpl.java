...
public final class RecursiveModelValuesImpl {
     ...
     */
    @ServiceInterface(name = "DictionaryClientRecu", host = "{endpoint}")
    public interface RecursiveModelValuesService {
        static RecursiveModelValuesService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName("type.dictionary.implementation.RecursiveModelValuesServiceImpl");
                return (RecursiveModelValuesService) clazz
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default Map<String, InnerModel> get(@HostParam("endpoint") String endpoint,
