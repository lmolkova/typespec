...
public final class SpreadStringsImpl {
    ...
    SpreadStringsImpl(AdditionalPropertiesClientImpl client) {
        this.service = RestProxy.create(SpreadStringsService.class, client.getHttpPipeline());
        this.client = client;
    }
    ...
    public interface SpreadStringsService {
        static SpreadStringsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz
                    = Class.forName("type.property.additionalproperties.implementation.SpreadStringsServiceImpl");
                return (SpreadStringsService) clazz
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default SpreadStringRecord get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept) {
