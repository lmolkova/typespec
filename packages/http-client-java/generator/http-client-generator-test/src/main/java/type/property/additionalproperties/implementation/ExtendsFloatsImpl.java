...
public final class ExtendsFloatsImpl {
    ...
    public interface ExtendsFloatsService {
        static ExtendsFloatsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz
                    = Class.forName("type.property.additionalproperties.implementation.ExtendsFloatsServiceImpl");
                return (ExtendsFloatsService) clazz
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default ExtendsFloatAdditionalProperties get(@HostParam("endpoint") String endpoint,
