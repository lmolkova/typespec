...
import routes.implementation.PathParametersSimpleExpansionStandardsImpl;

/**
 * Initializes a new instance of the synchronous RoutesClient type.
 */
@ServiceClient(builder = RoutesClientBuilder.class)
public final class PathParametersSimpleExpansionStandardClient {
    @Metadata(generated = true)
    private final PathParametersSimpleExpansionStandardsImpl serviceClient;

    private final Instrumentation instrumentation;

    /**
     * Initializes an instance of PathParametersSimpleExpansionStandardClient class.
     * 
     * @param serviceClient the service client implementation.
     * @param instrumentation the instrumentation instance.
     */
    @Metadata(generated = true)
    PathParametersSimpleExpansionStandardClient(PathParametersSimpleExpansionStandardsImpl serviceClient,
    ...
    public Response<Void> primitiveWithResponse(String param, RequestOptions requestOptions) {
        return this.instrumentation.instrumentWithResponse("Routes.PathParameters.SimpleExpansion.Standard.primitive",
    ...
    public Response<Void> arrayWithResponse(List<String> param, RequestOptions requestOptions) {
        return this.instrumentation.instrumentWithResponse("Routes.PathParameters.SimpleExpansion.Standard.array",
    ...
    public Response<Void> recordWithResponse(Map<String, Integer> param, RequestOptions requestOptions) {
        return this.instrumentation.instrumentWithResponse("Routes.PathParameters.SimpleExpansion.Standard.record",
