...
public final class ServiceClientClientBuilder
    implements HttpTrait<ServiceClientClientBuilder>, ProxyTrait<ServiceClientClientBuilder>,
    ...
    @Metadata(generated = true)
    @Override
    public ServiceClientClientBuilder httpPipeline(HttpPipeline pipeline) {
    ...
    @Metadata(generated = true)
    @Override
    public ServiceClientClientBuilder httpRetryOptions(HttpRetryOptions retryOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public ServiceClientClientBuilder addHttpPipelinePolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Metadata(generated = true)
    @Override
    public ServiceClientClientBuilder httpRedirectOptions(HttpRedirectOptions redirectOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public ServiceClientClientBuilder proxyOptions(ProxyOptions proxyOptions) {
    ...
    private ServiceClientClientImpl buildInnerClient() {
        ...
        ServiceClientClientImpl client = new ServiceClientClientImpl(localPipeline, this.endpoint, this.client);
        return client;
    }
    ...
    public ServiceClientClient buildClient() {
        ...
        return new ServiceClientClient(buildInnerClient(), instrumentation);
    }
    ...
    public BazFooClient buildBazFooClient() {
        ...
        Instrumentation instrumentation
            = Instrumentation.create(localHttpInstrumentationOptions, LIBRARY_INSTRUMENTATION_OPTIONS, null);
        return new BazFooClient(buildInnerClient().getBazFoos(), instrumentation);
    }
    ...
    public QuxClient buildQuxClient() {
        ...
        Instrumentation instrumentation
            = Instrumentation.create(localHttpInstrumentationOptions, LIBRARY_INSTRUMENTATION_OPTIONS, null);
        return new QuxClient(buildInnerClient().getQuxes(), instrumentation);
    }
    ...
    public QuxBarClient buildQuxBarClient() {
        ...
        Instrumentation instrumentation
            = Instrumentation.create(localHttpInstrumentationOptions, LIBRARY_INSTRUMENTATION_OPTIONS, null);
        return new QuxBarClient(buildInnerClient().getQuxBars(), instrumentation);
    }
    ...
    public FooClient buildFooClient() {
        ...
        Instrumentation instrumentation
            = Instrumentation.create(localHttpInstrumentationOptions, LIBRARY_INSTRUMENTATION_OPTIONS, null);
        return new FooClient(buildInnerClient().getFoos(), instrumentation);
    }
    ...
    public BarClient buildBarClient() {
        ...
        Instrumentation instrumentation
            = Instrumentation.create(localHttpInstrumentationOptions, LIBRARY_INSTRUMENTATION_OPTIONS, null);
        return new BarClient(buildInnerClient().getBars(), instrumentation);
    }
