 ...
 */
@ServiceClientBuilder(serviceClients = { ClientAClient.class })
public final class ClientAClientBuilder implements HttpTrait<ClientAClientBuilder>, ProxyTrait<ClientAClientBuilder>,
    ...
    @Metadata(generated = true)
    @Override
    public ClientAClientBuilder httpPipeline(HttpPipeline pipeline) {
    ...
    @Metadata(generated = true)
    @Override
    public ClientAClientBuilder httpRetryOptions(HttpRetryOptions retryOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public ClientAClientBuilder addHttpPipelinePolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Metadata(generated = true)
    @Override
    public ClientAClientBuilder httpRedirectOptions(HttpRedirectOptions redirectOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public ClientAClientBuilder httpInstrumentationOptions(HttpInstrumentationOptions httpInstrumentationOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public ClientAClientBuilder proxyOptions(ProxyOptions proxyOptions) {
    ...
    private ClientAClientImpl buildInnerClient() {
        ...
        ClientAClientImpl client = new ClientAClientImpl(localPipeline, this.endpoint, this.client);
        return client;
    }
    ...
    public ClientAClient buildClient() {
        ...
        return new ClientAClient(buildInnerClient(), instrumentation);
    }
