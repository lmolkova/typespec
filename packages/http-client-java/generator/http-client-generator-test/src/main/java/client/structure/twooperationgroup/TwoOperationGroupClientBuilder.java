 ...
 */
@ServiceClientBuilder(serviceClients = { Group1Client.class, Group2Client.class })
public final class TwoOperationGroupClientBuilder
    implements HttpTrait<TwoOperationGroupClientBuilder>, ProxyTrait<TwoOperationGroupClientBuilder>,
    ...
    @Metadata(generated = true)
    @Override
    public TwoOperationGroupClientBuilder httpPipeline(HttpPipeline pipeline) {
    ...
    @Metadata(generated = true)
    @Override
    public TwoOperationGroupClientBuilder httpRetryOptions(HttpRetryOptions retryOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public TwoOperationGroupClientBuilder addHttpPipelinePolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Metadata(generated = true)
    @Override
    public TwoOperationGroupClientBuilder httpRedirectOptions(HttpRedirectOptions redirectOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public TwoOperationGroupClientBuilder proxyOptions(ProxyOptions proxyOptions) {
    ...
    private TwoOperationGroupClientImpl buildInnerClient() {
        ...
        TwoOperationGroupClientImpl client = new TwoOperationGroupClientImpl(localPipeline, this.endpoint, this.client);
        return client;
    }
    ...
    public Group1Client buildGroup1Client() {
        ...
        return new Group1Client(buildInnerClient().getGroup1s(), instrumentation);
    }
    ...
    public Group2Client buildGroup2Client() {
        ...
        Instrumentation instrumentation
            = Instrumentation.create(localHttpInstrumentationOptions, LIBRARY_INSTRUMENTATION_OPTIONS, null);
        return new Group2Client(buildInnerClient().getGroup2s(), instrumentation);
    }
