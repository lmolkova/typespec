 ...
 */
@ServiceClientBuilder(serviceClients = { SecondClient.class, Group5Client.class })
public final class SecondClientBuilder implements HttpTrait<SecondClientBuilder>, ProxyTrait<SecondClientBuilder>,
    ...
    @Metadata(generated = true)
    @Override
    public SecondClientBuilder httpPipeline(HttpPipeline pipeline) {
    ...
    @Metadata(generated = true)
    @Override
    public SecondClientBuilder httpRetryOptions(HttpRetryOptions retryOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public SecondClientBuilder addHttpPipelinePolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Metadata(generated = true)
    @Override
    public SecondClientBuilder httpRedirectOptions(HttpRedirectOptions redirectOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public SecondClientBuilder httpInstrumentationOptions(HttpInstrumentationOptions httpInstrumentationOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public SecondClientBuilder proxyOptions(ProxyOptions proxyOptions) {
    ...
    private SecondClientImpl buildInnerClient() {
        ...
        SecondClientImpl client = new SecondClientImpl(localPipeline, this.endpoint, this.client);
        return client;
    }
    ...
    public SecondClient buildClient() {
        ...
        return new SecondClient(buildInnerClient(), instrumentation);
    }

    /**
     * Builds an instance of Group5Client class.
     * 
     * @return an instance of Group5Client.
     */
    @Metadata(generated = true)
    public Group5Client buildGroup5Client() {
        HttpInstrumentationOptions localHttpInstrumentationOptions = this.httpInstrumentationOptions == null
            ? new HttpInstrumentationOptions()
            : this.httpInstrumentationOptions;
        Instrumentation instrumentation
            = Instrumentation.create(localHttpInstrumentationOptions, LIBRARY_INSTRUMENTATION_OPTIONS, null);
        return new Group5Client(buildInnerClient().getGroup5s(), instrumentation);
    }
