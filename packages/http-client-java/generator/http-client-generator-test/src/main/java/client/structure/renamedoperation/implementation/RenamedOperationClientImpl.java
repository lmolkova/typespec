...
public final class RenamedOperationClientImpl {
     ...
     */
    public RenamedOperationClientImpl(HttpPipeline httpPipeline, String endpoint, ClientType client) {
        this.httpPipeline = httpPipeline;
        this.endpoint = endpoint;
        this.client = client;
        this.groups = new GroupsImpl(this);
        this.service = RestProxy.create(RenamedOperationClientService.class, this.httpPipeline);
    }
    ...
    public interface RenamedOperationClientService {
        static RenamedOperationClientService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer,
            @HostParam("endpoint") String endpoint, @HostParam("client") ClientType client) {
            try {
                Class<?> clazz = Class
                    .forName("client.structure.renamedoperation.implementation.RenamedOperationClientServiceImpl");
                return (RenamedOperationClientService) clazz
