 ...
 */
@ServiceClientBuilder(serviceClients = { RenamedOperationClient.class, GroupClient.class })
public final class RenamedOperationClientBuilder
    implements HttpTrait<RenamedOperationClientBuilder>, ProxyTrait<RenamedOperationClientBuilder>,
    ...
    @Metadata(generated = true)
    @Override
    public RenamedOperationClientBuilder httpPipeline(HttpPipeline pipeline) {
    ...
    @Metadata(generated = true)
    @Override
    public RenamedOperationClientBuilder httpRetryOptions(HttpRetryOptions retryOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public RenamedOperationClientBuilder addHttpPipelinePolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Metadata(generated = true)
    @Override
    public RenamedOperationClientBuilder httpRedirectOptions(HttpRedirectOptions redirectOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public RenamedOperationClientBuilder proxyOptions(ProxyOptions proxyOptions) {
    ...
    private RenamedOperationClientImpl buildInnerClient() {
        ...
        RenamedOperationClientImpl client = new RenamedOperationClientImpl(localPipeline, this.endpoint, this.client);
        return client;
    }
    ...
    public RenamedOperationClient buildClient() {
        ...
        return new RenamedOperationClient(buildInnerClient(), instrumentation);
    }
    ...
    public GroupClient buildGroupClient() {
        ...
        Instrumentation instrumentation
            = Instrumentation.create(localHttpInstrumentationOptions, LIBRARY_INSTRUMENTATION_OPTIONS, null);
        return new GroupClient(buildInnerClient().getGroups(), instrumentation);
    }
