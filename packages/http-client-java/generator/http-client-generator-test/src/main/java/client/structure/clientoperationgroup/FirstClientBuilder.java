 ...
 */
@ServiceClientBuilder(serviceClients = { FirstClient.class, Group3Client.class, Group4Client.class })
public final class FirstClientBuilder implements HttpTrait<FirstClientBuilder>, ProxyTrait<FirstClientBuilder>,
    ConfigurationTrait<FirstClientBuilder>, EndpointTrait<FirstClientBuilder> {
    ...
    @Metadata(generated = true)
    @Override
    public FirstClientBuilder httpPipeline(HttpPipeline pipeline) {
    ...
    @Metadata(generated = true)
    @Override
    public FirstClientBuilder httpRetryOptions(HttpRetryOptions retryOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public FirstClientBuilder addHttpPipelinePolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Metadata(generated = true)
    @Override
    public FirstClientBuilder httpRedirectOptions(HttpRedirectOptions redirectOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public FirstClientBuilder httpInstrumentationOptions(HttpInstrumentationOptions httpInstrumentationOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public FirstClientBuilder proxyOptions(ProxyOptions proxyOptions) {
    ...
    private FirstClientImpl buildInnerClient() {
        ...
        FirstClientImpl client = new FirstClientImpl(localPipeline, this.endpoint, this.client);
        return client;
    }
    ...
    public FirstClient buildClient() {
        ...
        return new FirstClient(buildInnerClient(), instrumentation);
    }

    /**
     * Builds an instance of Group3Client class.
     * 
     * @return an instance of Group3Client.
     */
    @Metadata(generated = true)
    public Group3Client buildGroup3Client() {
        HttpInstrumentationOptions localHttpInstrumentationOptions = this.httpInstrumentationOptions == null
            ? new HttpInstrumentationOptions()
            : this.httpInstrumentationOptions;
        Instrumentation instrumentation
            = Instrumentation.create(localHttpInstrumentationOptions, LIBRARY_INSTRUMENTATION_OPTIONS, null);
        return new Group3Client(buildInnerClient().getGroup3s(), instrumentation);
    }

    /**
     * Builds an instance of Group4Client class.
     * 
     * @return an instance of Group4Client.
     */
    @Metadata(generated = true)
    public Group4Client buildGroup4Client() {
        HttpInstrumentationOptions localHttpInstrumentationOptions = this.httpInstrumentationOptions == null
            ? new HttpInstrumentationOptions()
            : this.httpInstrumentationOptions;
        Instrumentation instrumentation
            = Instrumentation.create(localHttpInstrumentationOptions, LIBRARY_INSTRUMENTATION_OPTIONS, null);
        return new Group4Client(buildInnerClient().getGroup4s(), instrumentation);
    }
