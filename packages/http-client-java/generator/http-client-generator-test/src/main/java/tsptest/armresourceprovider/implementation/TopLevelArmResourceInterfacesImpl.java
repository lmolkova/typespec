...
import azure.resourcemanager.foundations.models.TopLevelArmResourceUpdate;
...
public final class TopLevelArmResourceInterfacesImpl implements TopLevelArmResourceInterfaces {
    ...
    public Response<TopLevelArmResource> updateWithResponse(String resourceGroupName, String topLevelArmResourceName,
        TopLevelArmResourceUpdate properties, Context context) {
        Response<TopLevelArmResourceInner> inner
            = this.serviceClient().updateWithResponse(resourceGroupName, topLevelArmResourceName, properties, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new TopLevelArmResourceImpl(inner.getValue(), this.manager()));
        } else {
