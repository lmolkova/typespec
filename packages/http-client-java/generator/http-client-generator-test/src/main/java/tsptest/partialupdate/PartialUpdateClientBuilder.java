 ...
 */
@ServiceClientBuilder(serviceClients = { PartialUpdateClient.class })
public final class PartialUpdateClientBuilder
    implements HttpTrait<PartialUpdateClientBuilder>, ProxyTrait<PartialUpdateClientBuilder>,
    ...
    @Metadata(generated = true)
    @Override
    public PartialUpdateClientBuilder httpPipeline(HttpPipeline pipeline) {
    ...
    @Metadata(generated = true)
    @Override
    public PartialUpdateClientBuilder httpRetryOptions(HttpRetryOptions retryOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public PartialUpdateClientBuilder addHttpPipelinePolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Metadata(generated = true)
    @Override
    public PartialUpdateClientBuilder httpRedirectOptions(HttpRedirectOptions redirectOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public PartialUpdateClientBuilder proxyOptions(ProxyOptions proxyOptions) {
    ...
    private PartialUpdateClientImpl buildInnerClient() {
        ...
        PartialUpdateClientImpl client = new PartialUpdateClientImpl(localPipeline, this.endpoint);
        return client;
    }
    ...
    public PartialUpdateClient buildClient() {
        ...
        return new PartialUpdateClient(buildInnerClient(), instrumentation);
    }
