...
public final class VisibilityClientBuilder
    ...
    @Metadata(generated = true)
    @Override
    public VisibilityClientBuilder httpPipeline(HttpPipeline pipeline) {
    ...
    @Metadata(generated = true)
    @Override
    public VisibilityClientBuilder httpRetryOptions(HttpRetryOptions retryOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public VisibilityClientBuilder addHttpPipelinePolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Metadata(generated = true)
    @Override
    public VisibilityClientBuilder httpRedirectOptions(HttpRedirectOptions redirectOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public VisibilityClientBuilder httpInstrumentationOptions(HttpInstrumentationOptions httpInstrumentationOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public VisibilityClientBuilder proxyOptions(ProxyOptions proxyOptions) {
    ...
    private VisibilityClientImpl buildInnerClient() {
        ...
        VisibilityClientImpl client = new VisibilityClientImpl(localPipeline, this.endpoint);
        return client;
    }
    ...
    public VisibilityClient buildClient() {
        ...
        return new VisibilityClient(buildInnerClient(), instrumentation);
    }
    ...
    public VisibilityReadClient buildVisibilityReadClient() {
        ...
        Instrumentation instrumentation
            = Instrumentation.create(localHttpInstrumentationOptions, LIBRARY_INSTRUMENTATION_OPTIONS, null);
        return new VisibilityReadClient(buildInnerClient().getVisibilityReads(), instrumentation);
    }
    ...
    public VisibilityWriteClient buildVisibilityWriteClient() {
        ...
        Instrumentation instrumentation
            = Instrumentation.create(localHttpInstrumentationOptions, LIBRARY_INSTRUMENTATION_OPTIONS, null);
        return new VisibilityWriteClient(buildInnerClient().getVisibilityWrites(), instrumentation);
    }
