 ...
 */
@ServiceClientBuilder(serviceClients = { DiscriminatorEdgeCasesClient.class })
public final class DiscriminatorEdgeCasesClientBuilder
    implements HttpTrait<DiscriminatorEdgeCasesClientBuilder>, ProxyTrait<DiscriminatorEdgeCasesClientBuilder>,
    ConfigurationTrait<DiscriminatorEdgeCasesClientBuilder>, EndpointTrait<DiscriminatorEdgeCasesClientBuilder> {
    ...
    @Metadata(generated = true)
    @Override
    public DiscriminatorEdgeCasesClientBuilder httpPipeline(HttpPipeline pipeline) {
    ...
    @Metadata(generated = true)
    @Override
    public DiscriminatorEdgeCasesClientBuilder httpRetryOptions(HttpRetryOptions retryOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public DiscriminatorEdgeCasesClientBuilder addHttpPipelinePolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Metadata(generated = true)
    @Override
    public DiscriminatorEdgeCasesClientBuilder httpRedirectOptions(HttpRedirectOptions redirectOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public DiscriminatorEdgeCasesClientBuilder proxyOptions(ProxyOptions proxyOptions) {
    ...
    private DiscriminatorEdgeCasesClientImpl buildInnerClient() {
        ...
        DiscriminatorEdgeCasesClientImpl client = new DiscriminatorEdgeCasesClientImpl(localPipeline, this.endpoint);
        return client;
    }
    ...
    public DiscriminatorEdgeCasesClient buildClient() {
        ...
        return new DiscriminatorEdgeCasesClient(buildInnerClient(), instrumentation);
    }
