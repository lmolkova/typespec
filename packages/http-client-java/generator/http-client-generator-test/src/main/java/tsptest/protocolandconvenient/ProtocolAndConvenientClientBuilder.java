...
import tsptest.protocolandconvenient.implementation.ProtocolAndConvenientClientImpl;

/**
 * A builder for creating a new instance of the ProtocolAndConvenientClient type.
 */
@ServiceClientBuilder(serviceClients = { ProtocolAndConvenientClient.class })
public final class ProtocolAndConvenientClientBuilder
    implements HttpTrait<ProtocolAndConvenientClientBuilder>, ProxyTrait<ProtocolAndConvenientClientBuilder>,
    ...
    @Metadata(generated = true)
    @Override
    public ProtocolAndConvenientClientBuilder httpPipeline(HttpPipeline pipeline) {
    ...
    @Metadata(generated = true)
    @Override
    public ProtocolAndConvenientClientBuilder httpRetryOptions(HttpRetryOptions retryOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public ProtocolAndConvenientClientBuilder addHttpPipelinePolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Metadata(generated = true)
    @Override
    public ProtocolAndConvenientClientBuilder httpRedirectOptions(HttpRedirectOptions redirectOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public ProtocolAndConvenientClientBuilder proxyOptions(ProxyOptions proxyOptions) {
    ...
    private ProtocolAndConvenientClientImpl buildInnerClient() {
        ...
        ProtocolAndConvenientClientImpl client
            = new ProtocolAndConvenientClientImpl(localPipeline, this.endpoint, localServiceVersion);
        return client;
    }
     ...
     */
    @Metadata(generated = true)
    public ProtocolAndConvenientClient buildProtocolAndConvenientClient() {
        HttpInstrumentationOptions localHttpInstrumentationOptions = this.httpInstrumentationOptions == null
            ? new HttpInstrumentationOptions()
            : this.httpInstrumentationOptions;
        Instrumentation instrumentation
            = Instrumentation.create(localHttpInstrumentationOptions, LIBRARY_INSTRUMENTATION_OPTIONS, null);
        return new ProtocolAndConvenientClient(buildInnerClient().getProtocolAndConvenienceOps(), instrumentation);
    }
