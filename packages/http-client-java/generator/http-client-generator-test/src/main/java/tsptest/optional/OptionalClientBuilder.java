...
import tsptest.optional.implementation.OptionalClientImpl;

/**
 * A builder for creating a new instance of the OptionalClient type.
 */
@ServiceClientBuilder(serviceClients = { OptionalClient.class })
public final class OptionalClientBuilder implements HttpTrait<OptionalClientBuilder>, ProxyTrait<OptionalClientBuilder>,
    ...
    private OptionalClientImpl buildInnerClient() {
        ...
        OptionalClientImpl client = new OptionalClientImpl(localPipeline, this.endpoint);
        return client;
    }
     ...
     */
    @Metadata(generated = true)
    public OptionalClient buildOptionalClient() {
        HttpInstrumentationOptions localHttpInstrumentationOptions = this.httpInstrumentationOptions == null
            ? new HttpInstrumentationOptions()
            : this.httpInstrumentationOptions;
        Instrumentation instrumentation
            = Instrumentation.create(localHttpInstrumentationOptions, LIBRARY_INSTRUMENTATION_OPTIONS, null);
        return new OptionalClient(buildInnerClient().getOptionalOps(), instrumentation);
    }
