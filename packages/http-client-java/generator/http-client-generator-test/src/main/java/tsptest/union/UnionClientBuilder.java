...
import tsptest.union.implementation.UnionClientImpl;
...
public final class UnionClientBuilder implements HttpTrait<UnionClientBuilder>, ProxyTrait<UnionClientBuilder>,
    ...
    private UnionClientImpl buildInnerClient() {
        ...
        UnionClientImpl client = new UnionClientImpl(localPipeline, this.endpoint, localServiceVersion);
        return client;
    }
     ...
     */
    @Metadata(generated = true)
    public UnionClient buildUnionClient() {
        HttpInstrumentationOptions localHttpInstrumentationOptions = this.httpInstrumentationOptions == null
            ? new HttpInstrumentationOptions()
            : this.httpInstrumentationOptions;
        Instrumentation instrumentation
            = Instrumentation.create(localHttpInstrumentationOptions, LIBRARY_INSTRUMENTATION_OPTIONS, null);
        return new UnionClient(buildInnerClient().getUnionFlattenOps(), instrumentation);
    }
