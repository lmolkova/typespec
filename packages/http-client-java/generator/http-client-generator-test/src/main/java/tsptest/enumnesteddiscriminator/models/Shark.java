...
public class Shark extends Fish {
     ...
     */
    @Metadata(generated = true)
    private SharkKind sharktype = SharkKind.fromValue("shark");
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("sharktype", this.sharktype == null ? null : this.sharktype.getValue());
    ...
    static Shark fromJsonKnownDiscriminator(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            int age = 0;
            SharkKind sharktype = SharkKind.fromValue("shark");
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("age".equals(fieldName)) {
                    ...
                    sharktype = SharkKind.fromValue(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }
