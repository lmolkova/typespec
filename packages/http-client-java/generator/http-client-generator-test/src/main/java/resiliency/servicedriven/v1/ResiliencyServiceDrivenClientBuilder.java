 ...
 */
@ServiceClientBuilder(serviceClients = { ResiliencyServiceDrivenClient.class })
public final class ResiliencyServiceDrivenClientBuilder
    implements HttpTrait<ResiliencyServiceDrivenClientBuilder>, ProxyTrait<ResiliencyServiceDrivenClientBuilder>,
    ...
    @Metadata(generated = true)
    @Override
    public ResiliencyServiceDrivenClientBuilder httpPipeline(HttpPipeline pipeline) {
    ...
    @Metadata(generated = true)
    @Override
    public ResiliencyServiceDrivenClientBuilder httpRetryOptions(HttpRetryOptions retryOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public ResiliencyServiceDrivenClientBuilder addHttpPipelinePolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Metadata(generated = true)
    @Override
    public ResiliencyServiceDrivenClientBuilder httpRedirectOptions(HttpRedirectOptions redirectOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public ResiliencyServiceDrivenClientBuilder proxyOptions(ProxyOptions proxyOptions) {
    ...
    private ResiliencyServiceDrivenClientImpl buildInnerClient() {
        ...
        ResiliencyServiceDrivenClientImpl client = new ResiliencyServiceDrivenClientImpl(localPipeline, this.endpoint,
            this.serviceDeploymentVersion, localServiceVersion);
        return client;
    }
    ...
    public ResiliencyServiceDrivenClient buildClient() {
        ...
        return new ResiliencyServiceDrivenClient(buildInnerClient(), instrumentation);
    }
