...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(OperationTemplatesClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for OperationTemplatesClientOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    ...
    public interface OperationsService {
        ...
        @Get("/providers/Azure.ResourceManager.OperationTemplates/operations")
