 ...
 */
@ServiceClientBuilder(serviceClients = { RpcClient.class })
public final class RpcClientBuilder implements HttpTrait<RpcClientBuilder>, ProxyTrait<RpcClientBuilder>,
    ConfigurationTrait<RpcClientBuilder>, EndpointTrait<RpcClientBuilder> {
    ...
    @Metadata(generated = true)
    @Override
    public RpcClientBuilder httpPipeline(HttpPipeline pipeline) {
    ...
    @Metadata(generated = true)
    @Override
    public RpcClientBuilder httpRetryOptions(HttpRetryOptions retryOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public RpcClientBuilder addHttpPipelinePolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Metadata(generated = true)
    @Override
    public RpcClientBuilder httpRedirectOptions(HttpRedirectOptions redirectOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public RpcClientBuilder httpInstrumentationOptions(HttpInstrumentationOptions httpInstrumentationOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public RpcClientBuilder proxyOptions(ProxyOptions proxyOptions) {
    ...
    private RpcClientImpl buildInnerClient() {
        ...
        RpcClientImpl client = new RpcClientImpl(localPipeline, localEndpoint, localServiceVersion);
        return client;
    }
    ...
    public RpcClient buildClient() {
        ...
        return new RpcClient(buildInnerClient(), instrumentation);
    }
