...
import azure.resourcemanager.implementation.models.NestedProxyResourceListResult;
...
import com.azure.v2.core.annotation.Delete;
 ...
 */
public final class NestedsClientImpl implements NestedsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final NestedsService service;
    ...
    /**
     * Initializes an instance of NestedsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    NestedsClientImpl(ResourcesClientImpl client) {
        this.service = RestProxy.create(NestedsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for ResourcesClientNesteds to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{endpoint}")
    ...
    public interface NestedsService {
        ...
        @Put("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resources/topLevelTrackedResources/{topLevelTrackedResourceName}/nestedProxyResources/{nextedProxyResourceName}")
        ...
        @Patch("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resources/topLevelTrackedResources/{topLevelTrackedResourceName}/nestedProxyResources/{nextedProxyResourceName}")
