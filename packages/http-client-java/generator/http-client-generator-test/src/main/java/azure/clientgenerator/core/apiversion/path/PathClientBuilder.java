...
/**
 * A builder for creating a new instance of the PathClient type.
 */
...
public final class PathClientBuilder implements HttpTrait<PathClientBuilder>, ProxyTrait<PathClientBuilder>,
    ...
    /**
     * Create an instance of the PathClientBuilder.
     */
    @Metadata(generated = true)
    ...
    @Metadata(generated = true)
    @Override
    public PathClientBuilder httpPipeline(HttpPipeline pipeline) {
    ...
    @Metadata(generated = true)
    @Override
    public PathClientBuilder httpRetryOptions(HttpRetryOptions retryOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public PathClientBuilder addHttpPipelinePolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Metadata(generated = true)
    @Override
    public PathClientBuilder httpRedirectOptions(HttpRedirectOptions redirectOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public PathClientBuilder httpInstrumentationOptions(HttpInstrumentationOptions httpInstrumentationOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public PathClientBuilder proxyOptions(ProxyOptions proxyOptions) {
     ...
     */
    @Metadata(generated = true)
    private PathServiceVersion serviceVersion;

    /**
     * Sets Service version.
     * 
     * @param serviceVersion the serviceVersion value.
     * @return the PathClientBuilder.
     */
    @Metadata(generated = true)
    public PathClientBuilder serviceVersion(PathServiceVersion serviceVersion) {
    ...
    private PathClientImpl buildInnerClient() {
        ...
        PathServiceVersion localServiceVersion
            = (serviceVersion != null) ? serviceVersion : PathServiceVersion.getLatest();
        PathClientImpl client = new PathClientImpl(localPipeline, localEndpoint, localServiceVersion);
        return client;
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(PathClientBuilder.class);
}
