...
import azure.core.scalar.implementation.ScalarClientImpl;
 ...
 */
@ServiceClientBuilder(serviceClients = { ScalarClient.class })
public final class ScalarClientBuilder implements HttpTrait<ScalarClientBuilder>, ProxyTrait<ScalarClientBuilder>,
    ...
    private ScalarClientImpl buildInnerClient() {
        ...
        ScalarClientImpl client = new ScalarClientImpl(localPipeline, localEndpoint, localServiceVersion);
        return client;
    }
     ...
     */
    @Metadata(generated = true)
    public ScalarClient buildScalarClient() {
        HttpInstrumentationOptions localHttpInstrumentationOptions = this.httpInstrumentationOptions == null
            ? new HttpInstrumentationOptions()
            : this.httpInstrumentationOptions;
        Instrumentation instrumentation
            = Instrumentation.create(localHttpInstrumentationOptions, LIBRARY_INSTRUMENTATION_OPTIONS, null);
        return new ScalarClient(buildInnerClient().getAzureLocationScalars(), instrumentation);
    }
