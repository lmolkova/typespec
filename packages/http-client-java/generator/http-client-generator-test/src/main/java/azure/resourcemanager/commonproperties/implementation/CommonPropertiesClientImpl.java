...
import com.azure.v2.core.http.HttpHeaderName;
...
/**
 * Initializes a new instance of the CommonPropertiesClientImpl type.
 */
@ServiceClient(builder = CommonPropertiesClientBuilder.class)
public final class CommonPropertiesClientImpl implements CommonPropertiesClient {
    /**
     * Service host.
     */
    ...
    /**
     * The ManagedIdentitiesClient object to access its operations.
     */
    private final ManagedIdentitiesClient managedIdentities;
     ...
     */
    public ManagedIdentitiesClient getManagedIdentities() {
     ...
     */
    CommonPropertiesClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(CommonPropertiesClientImpl.class);
}
