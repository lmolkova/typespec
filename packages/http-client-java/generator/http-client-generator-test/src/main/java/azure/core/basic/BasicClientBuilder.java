 ...
 */
@ServiceClientBuilder(serviceClients = { BasicClient.class })
public final class BasicClientBuilder implements HttpTrait<BasicClientBuilder>, ProxyTrait<BasicClientBuilder>,
    ...
    @Metadata(generated = true)
    @Override
    public BasicClientBuilder httpPipeline(HttpPipeline pipeline) {
    ...
    @Metadata(generated = true)
    @Override
    public BasicClientBuilder httpRetryOptions(HttpRetryOptions retryOptions) {
    ...
    private BasicClientImpl buildInnerClient() {
        ...
        BasicClientImpl client = new BasicClientImpl(localPipeline, localEndpoint, localServiceVersion);
        return client;
    }
    ...
    public BasicClient buildClient() {
        ...
        return new BasicClient(buildInnerClient(), instrumentation);
    }
