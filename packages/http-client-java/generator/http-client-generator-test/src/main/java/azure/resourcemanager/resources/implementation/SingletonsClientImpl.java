...
import azure.resourcemanager.implementation.models.SingletonTrackedResourceListResult;
 ...
 */
public final class SingletonsClientImpl implements SingletonsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final SingletonsService service;
    ...
    /**
     * Initializes an instance of SingletonsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    SingletonsClientImpl(ResourcesClientImpl client) {
        this.service
            = RestProxy.create(SingletonsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for ResourcesClientSingletons to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{endpoint}")
    ...
    public interface SingletonsService {
        ...
        @Put("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resources/singletonTrackedResources/default")
        ...
        @Patch("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resources/singletonTrackedResources/default")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resources/singletonTrackedResources")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
