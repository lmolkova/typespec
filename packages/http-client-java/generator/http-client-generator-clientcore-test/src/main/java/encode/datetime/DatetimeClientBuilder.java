...
import encode.datetime.implementation.DatetimeClientImpl;
...
public final class DatetimeClientBuilder implements HttpTrait<DatetimeClientBuilder>, ProxyTrait<DatetimeClientBuilder>,
    ...
    @Metadata(generated = true)
    @Override
    public DatetimeClientBuilder httpPipeline(HttpPipeline pipeline) {
    ...
    @Metadata(generated = true)
    @Override
    public DatetimeClientBuilder httpRetryOptions(HttpRetryOptions retryOptions) {
    ...
    private DatetimeClientImpl buildInnerClient() {
        ...
        DatetimeClientImpl client = new DatetimeClientImpl(localPipeline, localEndpoint);
        return client;
    }
