...
public final class FloatsOnliesImpl {
    ...
    public interface FloatsOnliesService {
        static FloatsOnliesService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName("type.union.implementation.FloatsOnliesServiceImpl");
                return (FloatsOnliesService) clazz
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default GetResponse5 get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept) {
        ...
        default void send(@HostParam("endpoint") String endpoint, @HeaderParam("Content-Type") String contentType,
            @BodyParam("application/json") BinaryData sendRequest5) {
            send(endpoint, contentType, sendRequest5, null);
        }
    }
    ...
    public Response<Void> sendWithResponse(BinaryData sendRequest5, RequestOptions requestOptions) {
        ...
        return service.send(this.client.getEndpoint(), contentType, sendRequest5, requestOptions);
    }
}
