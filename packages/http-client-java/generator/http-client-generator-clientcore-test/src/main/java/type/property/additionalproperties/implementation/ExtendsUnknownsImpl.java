...
public final class ExtendsUnknownsImpl {
    ...
    public interface ExtendsUnknownsService {
        static ExtendsUnknownsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz
                    = Class.forName("type.property.additionalproperties.implementation.ExtendsUnknownsServiceImpl");
                return (ExtendsUnknownsService) clazz
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default ExtendsUnknownAdditionalProperties get(@HostParam("endpoint") String endpoint,
