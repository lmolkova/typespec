 ...
 */
@ServiceClientBuilder(serviceClients = { NotDiscriminatedClient.class })
public final class NotDiscriminatedClientBuilder
    ...
    @Metadata(generated = true)
    @Override
    public NotDiscriminatedClientBuilder httpPipeline(HttpPipeline pipeline) {
    ...
    @Metadata(generated = true)
    @Override
    public NotDiscriminatedClientBuilder httpRetryOptions(HttpRetryOptions retryOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public NotDiscriminatedClientBuilder addHttpPipelinePolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Metadata(generated = true)
    @Override
    public NotDiscriminatedClientBuilder httpRedirectOptions(HttpRedirectOptions redirectOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public NotDiscriminatedClientBuilder proxyOptions(ProxyOptions proxyOptions) {
    ...
    private NotDiscriminatedClientImpl buildInnerClient() {
        ...
        NotDiscriminatedClientImpl client = new NotDiscriminatedClientImpl(localPipeline, localEndpoint);
        return client;
    }
