...
import type.property.additionalproperties.SpreadModelRecord;
...
public final class SpreadModelsImpl {
    ...
    SpreadModelsImpl(AdditionalPropertiesClientImpl client) {
        this.service = RestProxy.create(SpreadModelsService.class, client.getHttpPipeline());
        this.client = client;
    }
    ...
    public interface SpreadModelsService {
        static SpreadModelsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz
                    = Class.forName("type.property.additionalproperties.implementation.SpreadModelsServiceImpl");
                return (SpreadModelsService) clazz
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default SpreadModelRecord get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept) {
