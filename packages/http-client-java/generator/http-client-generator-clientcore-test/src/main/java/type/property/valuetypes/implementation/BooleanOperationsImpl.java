...
import type.property.valuetypes.BooleanProperty;
...
public final class BooleanOperationsImpl {
    ...
    public interface BooleanOperationsService {
        static BooleanOperationsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName("type.property.valuetypes.implementation.BooleanOperationsServiceImpl");
                return (BooleanOperationsService) clazz
        ...
        Response<BooleanProperty> get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default BooleanProperty get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept) {
     ...
     * @return call.
     */
    public Response<BooleanProperty> getWithResponse(RequestOptions requestOptions) {
