...
public final class UnknownDictClient {
     ...
     */
    @Metadata(generated = true)
    UnknownDictClient(UnknownDictsImpl serviceClient, Instrumentation instrumentation) {
    ...
    public Response<UnknownDictProperty> getWithResponse(RequestOptions requestOptions) {
        return this.instrumentation.instrumentWithResponse("Type.Property.ValueTypes.UnknownDict.get", requestOptions,
    ...
    public Response<Void> putWithResponse(BinaryData body, RequestOptions requestOptions) {
        return this.instrumentation.instrumentWithResponse("Type.Property.ValueTypes.UnknownDict.put", requestOptions,
