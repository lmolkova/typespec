...
import type.enums.extensible.implementation.ExtensibleClientImpl;
...
public final class ExtensibleClientBuilder
    ...
    @Metadata(generated = true)
    @Override
    public ExtensibleClientBuilder httpPipeline(HttpPipeline pipeline) {
    ...
    private ExtensibleClientImpl buildInnerClient() {
        ...
        ExtensibleClientImpl client = new ExtensibleClientImpl(localPipeline, localEndpoint);
        return client;
    }
