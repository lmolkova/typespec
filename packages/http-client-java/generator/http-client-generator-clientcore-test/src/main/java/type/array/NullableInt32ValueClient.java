...
public final class NullableInt32ValueClient {
    ...
    public Response<List<Integer>> getWithResponse(RequestOptions requestOptions) {
        return this.instrumentation.instrumentWithResponse("Type.Array.NullableInt32Value.get", requestOptions,
    ...
    public Response<Void> putWithResponse(BinaryData body, RequestOptions requestOptions) {
        return this.instrumentation.instrumentWithResponse("Type.Array.NullableInt32Value.put", requestOptions,
