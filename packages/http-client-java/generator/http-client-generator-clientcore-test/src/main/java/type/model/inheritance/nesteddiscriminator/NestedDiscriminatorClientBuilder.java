...
public final class NestedDiscriminatorClientBuilder
    ...
    @Metadata(generated = true)
    @Override
    public NestedDiscriminatorClientBuilder httpPipeline(HttpPipeline pipeline) {
    ...
    private NestedDiscriminatorClientImpl buildInnerClient() {
        ...
        NestedDiscriminatorClientImpl client = new NestedDiscriminatorClientImpl(localPipeline, localEndpoint);
        return client;
    }
    ...
    public NestedDiscriminatorClient buildClient() {
        ...
        return new NestedDiscriminatorClient(buildInnerClient(), instrumentation);
    }
