...
public final class IsStringsImpl {
    ...
    public interface IsStringsService {
        static IsStringsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz
                    = Class.forName("type.property.additionalproperties.implementation.IsStringsServiceImpl");
                return (IsStringsService) clazz.getMethod("getNewInstance", HttpPipeline.class, ObjectSerializer.class)
        ...
        Response<IsStringAdditionalProperties> get(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default IsStringAdditionalProperties get(@HostParam("endpoint") String endpoint,
