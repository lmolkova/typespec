...
public final class CollectionsStringClient {
    ...
    public Response<CollectionsStringProperty> getWithResponse(RequestOptions requestOptions) {
        return this.instrumentation.instrument("Type.Property.ValueTypes.CollectionsString.get", requestOptions,
    ...
    public Response<Void> putWithResponse(BinaryData body, RequestOptions requestOptions) {
        return this.instrumentation.instrument("Type.Property.ValueTypes.CollectionsString.put", requestOptions,
