...
public final class UnknownValuesImpl {
     ...
     * REST calls.
     */
    @ServiceInterface(name = "ArrayClientUnknownVa", host = "{endpoint}")
    public interface UnknownValuesService {
        static UnknownValuesService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName("type.array.implementation.UnknownValuesServiceImpl");
                return (UnknownValuesService) clazz
        ...
        Response<List<Object>> get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept,
            RequestOptions requestOptions);

        @HttpRequestInformation(method = HttpMethod.GET, path = "/type/array/unknown", expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default List<Object> get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept) {
