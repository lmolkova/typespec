...
import type.property.valuetypes.BytesProperty;
...
public final class BytesImpl {
     ...
     * calls.
     */
    @ServiceInterface(name = "ValueTypesClientByte", host = "{endpoint}")
    public interface BytesService {
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default BytesProperty get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept) {
