...
public final class IsUnknownsImpl {
    ...
    public interface IsUnknownsService {
        static IsUnknownsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz
                    = Class.forName("type.property.additionalproperties.implementation.IsUnknownsServiceImpl");
                return (IsUnknownsService) clazz.getMethod("getNewInstance", HttpPipeline.class, ObjectSerializer.class)
        ...
        Response<IsUnknownAdditionalProperties> get(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default IsUnknownAdditionalProperties get(@HostParam("endpoint") String endpoint,
