 ...
 */
@ServiceClientBuilder(serviceClients = { EnumDiscriminatorClient.class })
public final class EnumDiscriminatorClientBuilder
    ...
    @Metadata(generated = true)
    @Override
    public EnumDiscriminatorClientBuilder httpPipeline(HttpPipeline pipeline) {
    ...
    @Metadata(generated = true)
    @Override
    public EnumDiscriminatorClientBuilder httpRetryOptions(HttpRetryOptions retryOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public EnumDiscriminatorClientBuilder addHttpPipelinePolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Metadata(generated = true)
    @Override
    public EnumDiscriminatorClientBuilder proxyOptions(ProxyOptions proxyOptions) {
    ...
    private EnumDiscriminatorClientImpl buildInnerClient() {
        ...
        EnumDiscriminatorClientImpl client = new EnumDiscriminatorClientImpl(localPipeline, localEndpoint);
        return client;
    }
