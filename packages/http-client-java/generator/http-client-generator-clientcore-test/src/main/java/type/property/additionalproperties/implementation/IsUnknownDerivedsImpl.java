...
import type.property.additionalproperties.IsUnknownAdditionalPropertiesDerived;
...
public final class IsUnknownDerivedsImpl {
    ...
    IsUnknownDerivedsImpl(AdditionalPropertiesClientImpl client) {
        this.service = RestProxy.create(IsUnknownDerivedsService.class, client.getHttpPipeline());
        this.client = client;
    }
    ...
    public interface IsUnknownDerivedsService {
        static IsUnknownDerivedsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz
                    = Class.forName("type.property.additionalproperties.implementation.IsUnknownDerivedsServiceImpl");
                return (IsUnknownDerivedsService) clazz
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default IsUnknownAdditionalPropertiesDerived get(@HostParam("endpoint") String endpoint,
