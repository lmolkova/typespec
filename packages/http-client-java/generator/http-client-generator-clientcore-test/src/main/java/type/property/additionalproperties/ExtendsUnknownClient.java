...
public final class ExtendsUnknownClient {
     ...
     */
    @Metadata(generated = true)
    public Response<ExtendsUnknownAdditionalProperties> getWithResponse(RequestOptions requestOptions) {
        return this.instrumentation.instrument("Type.Property.AdditionalProperties.ExtendsUnknown.get", requestOptions,
    ...
    public Response<Void> putWithResponse(BinaryData body, RequestOptions requestOptions) {
        return this.instrumentation.instrument("Type.Property.AdditionalProperties.ExtendsUnknown.put", requestOptions,
