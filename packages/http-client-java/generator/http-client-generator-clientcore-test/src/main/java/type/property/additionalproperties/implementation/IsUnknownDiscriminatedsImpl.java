...
public final class IsUnknownDiscriminatedsImpl {
    ...
    public interface IsUnknownDiscriminatedsService {
        static IsUnknownDiscriminatedsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class
                    .forName("type.property.additionalproperties.implementation.IsUnknownDiscriminatedsServiceImpl");
                return (IsUnknownDiscriminatedsService) clazz
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default IsUnknownAdditionalPropertiesDiscriminated get(@HostParam("endpoint") String endpoint,
