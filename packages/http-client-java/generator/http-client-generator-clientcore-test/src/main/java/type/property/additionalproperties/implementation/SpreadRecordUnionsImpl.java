...
public final class SpreadRecordUnionsImpl {
    ...
    public interface SpreadRecordUnionsService {
        static SpreadRecordUnionsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz
                    = Class.forName("type.property.additionalproperties.implementation.SpreadRecordUnionsServiceImpl");
                return (SpreadRecordUnionsService) clazz
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default SpreadRecordForUnion get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept) {
