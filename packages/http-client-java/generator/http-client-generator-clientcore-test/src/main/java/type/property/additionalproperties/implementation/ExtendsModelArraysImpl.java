...
public final class ExtendsModelArraysImpl {
    ...
    public interface ExtendsModelArraysService {
        static ExtendsModelArraysService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz
                    = Class.forName("type.property.additionalproperties.implementation.ExtendsModelArraysServiceImpl");
                return (ExtendsModelArraysService) clazz
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default ExtendsModelArrayAdditionalProperties get(@HostParam("endpoint") String endpoint,
