...
import type.property.valuetypes.IntProperty;
...
public final class IntsImpl {
     ...
     * calls.
     */
    @ServiceInterface(name = "ValueTypesClientInts", host = "{endpoint}")
    public interface IntsService {
        static IntsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName("type.property.valuetypes.implementation.IntsServiceImpl");
                return (IntsService) clazz.getMethod("getNewInstance", HttpPipeline.class, ObjectSerializer.class)
        ...
        Response<IntProperty> get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default IntProperty get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept) {
     ...
     * @return call.
     */
    public Response<IntProperty> getWithResponse(RequestOptions requestOptions) {
