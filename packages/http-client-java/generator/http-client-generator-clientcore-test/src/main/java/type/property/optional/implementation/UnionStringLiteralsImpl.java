...
public final class UnionStringLiteralsImpl {
    ...
    public interface UnionStringLiteralsService {
        static UnionStringLiteralsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName("type.property.optional.implementation.UnionStringLiteralsServiceImpl");
                return (UnionStringLiteralsService) clazz
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default UnionStringLiteralProperty getAll(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default UnionStringLiteralProperty getDefault(@HostParam("endpoint") String endpoint,
            @HeaderParam("Accept") String accept) {
