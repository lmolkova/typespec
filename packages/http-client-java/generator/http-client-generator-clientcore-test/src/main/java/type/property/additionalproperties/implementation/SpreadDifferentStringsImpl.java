...
public final class SpreadDifferentStringsImpl {
    ...
    public interface SpreadDifferentStringsService {
        static SpreadDifferentStringsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class
                    .forName("type.property.additionalproperties.implementation.SpreadDifferentStringsServiceImpl");
                return (SpreadDifferentStringsService) clazz
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default DifferentSpreadStringRecord get(@HostParam("endpoint") String endpoint,
