...
import type.enums.fixed.implementation.FixedClientImpl;
...
public final class FixedClientBuilder implements HttpTrait<FixedClientBuilder>, ProxyTrait<FixedClientBuilder>,
    ...
    @Metadata(generated = true)
    @Override
    public FixedClientBuilder httpPipeline(HttpPipeline pipeline) {
    ...
    private FixedClientImpl buildInnerClient() {
        ...
        FixedClientImpl client = new FixedClientImpl(localPipeline, localEndpoint);
        return client;
    }
