 ...
 */
@ServiceClientBuilder(serviceClients = { RecursiveClient.class })
public final class RecursiveClientBuilder
    ...
    @Metadata(generated = true)
    @Override
    public RecursiveClientBuilder httpPipeline(HttpPipeline pipeline) {
    ...
    @Metadata(generated = true)
    @Override
    public RecursiveClientBuilder httpRetryOptions(HttpRetryOptions retryOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public RecursiveClientBuilder addHttpPipelinePolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Metadata(generated = true)
    @Override
    public RecursiveClientBuilder httpRedirectOptions(HttpRedirectOptions redirectOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public RecursiveClientBuilder httpInstrumentationOptions(HttpInstrumentationOptions httpInstrumentationOptions) {
    ...
    @Metadata(generated = true)
    @Override
    public RecursiveClientBuilder proxyOptions(ProxyOptions proxyOptions) {
    ...
    private RecursiveClientImpl buildInnerClient() {
        ...
        RecursiveClientImpl client = new RecursiveClientImpl(localPipeline, localEndpoint);
        return client;
    }
    ...
    public RecursiveClient buildClient() {
        ...
        return new RecursiveClient(buildInnerClient(), instrumentation);
    }
