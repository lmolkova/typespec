...
public final class UnknownIntsImpl {
    ...
    UnknownIntsImpl(ValueTypesClientImpl client) {
        this.service = RestProxy.create(UnknownIntsService.class, client.getHttpPipeline());
        this.client = client;
    }
    ...
    public interface UnknownIntsService {
        static UnknownIntsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName("type.property.valuetypes.implementation.UnknownIntsServiceImpl");
                return (UnknownIntsService) clazz
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default UnknownIntProperty get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept) {
