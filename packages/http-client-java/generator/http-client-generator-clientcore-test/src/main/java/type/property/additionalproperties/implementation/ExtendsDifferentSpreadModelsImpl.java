...
public final class ExtendsDifferentSpreadModelsImpl {
    ...
    public interface ExtendsDifferentSpreadModelsService {
        static ExtendsDifferentSpreadModelsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName(
                    "type.property.additionalproperties.implementation.ExtendsDifferentSpreadModelsServiceImpl");
                return (ExtendsDifferentSpreadModelsService) clazz
        ...
        Response<DifferentSpreadModelDerived> get(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default DifferentSpreadModelDerived get(@HostParam("endpoint") String endpoint,
