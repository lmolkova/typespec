...
public final class CollectionsModelsImpl {
    ...
    public interface CollectionsModelsService {
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default CollectionsModelProperty get(@HostParam("endpoint") String endpoint,
     ...
     * @return call.
     */
    public Response<CollectionsModelProperty> getWithResponse(RequestOptions requestOptions) {
