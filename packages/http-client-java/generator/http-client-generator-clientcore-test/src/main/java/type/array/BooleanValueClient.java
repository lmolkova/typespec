...
import type.array.implementation.BooleanValuesImpl;
...
public final class BooleanValueClient {
     ...
     */
    @Metadata(generated = true)
    BooleanValueClient(BooleanValuesImpl serviceClient, Instrumentation instrumentation) {
    ...
    public Response<List<Boolean>> getWithResponse(RequestOptions requestOptions) {
        return this.instrumentation.instrumentWithResponse("Type.Array.BooleanValue.get", requestOptions,
    ...
    public Response<Void> putWithResponse(BinaryData body, RequestOptions requestOptions) {
        return this.instrumentation.instrumentWithResponse("Type.Array.BooleanValue.put", requestOptions,
