...
import type.property.valuetypes.UnknownArrayProperty;
...
public final class UnknownArraysImpl {
    ...
    UnknownArraysImpl(ValueTypesClientImpl client) {
        this.service = RestProxy.create(UnknownArraysService.class, client.getHttpPipeline());
        this.client = client;
    }
    ...
    public interface UnknownArraysService {
        static UnknownArraysService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName("type.property.valuetypes.implementation.UnknownArraysServiceImpl");
                return (UnknownArraysService) clazz
        ...
        Response<UnknownArrayProperty> get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default UnknownArrayProperty get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept) {
