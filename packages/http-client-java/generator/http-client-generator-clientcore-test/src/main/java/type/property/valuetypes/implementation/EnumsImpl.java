...
public final class EnumsImpl {
     ...
     * calls.
     */
    @ServiceInterface(name = "ValueTypesClientEnum", host = "{endpoint}")
    public interface EnumsService {
        static EnumsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName("type.property.valuetypes.implementation.EnumsServiceImpl");
                return (EnumsService) clazz.getMethod("getNewInstance", HttpPipeline.class, ObjectSerializer.class)
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default EnumProperty get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept) {
