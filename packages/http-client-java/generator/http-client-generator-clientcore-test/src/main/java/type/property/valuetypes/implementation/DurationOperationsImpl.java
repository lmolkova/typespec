...
public final class DurationOperationsImpl {
    ...
    public interface DurationOperationsService {
        static DurationOperationsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName("type.property.valuetypes.implementation.DurationOperationsServiceImpl");
        ...
        Response<DurationProperty> get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default DurationProperty get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept) {
