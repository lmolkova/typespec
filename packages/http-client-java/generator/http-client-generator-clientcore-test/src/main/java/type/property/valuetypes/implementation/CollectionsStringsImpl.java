...
import type.property.valuetypes.CollectionsStringProperty;
...
public final class CollectionsStringsImpl {
    ...
    public interface CollectionsStringsService {
        static CollectionsStringsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName("type.property.valuetypes.implementation.CollectionsStringsServiceImpl");
                return (CollectionsStringsService) clazz
        ...
        Response<CollectionsStringProperty> get(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default CollectionsStringProperty get(@HostParam("endpoint") String endpoint,
