...
import type.property.additionalproperties.ExtendsModelAdditionalProperties;
...
public final class ExtendsModelsImpl {
    ...
    ExtendsModelsImpl(AdditionalPropertiesClientImpl client) {
        this.service = RestProxy.create(ExtendsModelsService.class, client.getHttpPipeline());
        this.client = client;
    }
    ...
    public interface ExtendsModelsService {
        static ExtendsModelsService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz
                    = Class.forName("type.property.additionalproperties.implementation.ExtendsModelsServiceImpl");
                return (ExtendsModelsService) clazz
        ...
        Response<ExtendsModelAdditionalProperties> get(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default ExtendsModelAdditionalProperties get(@HostParam("endpoint") String endpoint,
