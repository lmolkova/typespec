...
public final class DurationValuesImpl {
     ...
     * REST calls.
     */
    @ServiceInterface(name = "ArrayClientDurationV", host = "{endpoint}")
    public interface DurationValuesService {
        static DurationValuesService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName("type.array.implementation.DurationValuesServiceImpl");
                return (DurationValuesService) clazz
        ...
        @HttpRequestInformation(method = HttpMethod.GET, path = "/type/array/duration", expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default List<Duration> get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept) {
     ...
     * @return the response.
     */
    public Response<List<Duration>> getWithResponse(RequestOptions requestOptions) {
