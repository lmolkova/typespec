...
public final class NullableFloatValuesImpl {
    ...
    public interface NullableFloatValuesService {
        static NullableFloatValuesService getNewInstance(HttpPipeline pipeline, ObjectSerializer serializer) {
            try {
                Class<?> clazz = Class.forName("type.dictionary.implementation.NullableFloatValuesServiceImpl");
                return (NullableFloatValuesService) clazz
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        default Map<String, Double> get(@HostParam("endpoint") String endpoint, @HeaderParam("Accept") String accept) {
