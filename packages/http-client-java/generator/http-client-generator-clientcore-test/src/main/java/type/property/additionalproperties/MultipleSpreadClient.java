...
import type.property.additionalproperties.implementation.MultipleSpreadsImpl;
...
public final class MultipleSpreadClient {
     ...
     */
    @Metadata(generated = true)
    MultipleSpreadClient(MultipleSpreadsImpl serviceClient, Instrumentation instrumentation) {
    ...
    public Response<MultipleSpreadRecord> getWithResponse(RequestOptions requestOptions) {
        return this.instrumentation.instrument("Type.Property.AdditionalProperties.MultipleSpread.get", requestOptions,
    ...
    public Response<Void> putWithResponse(BinaryData body, RequestOptions requestOptions) {
        return this.instrumentation.instrument("Type.Property.AdditionalProperties.MultipleSpread.put", requestOptions,
