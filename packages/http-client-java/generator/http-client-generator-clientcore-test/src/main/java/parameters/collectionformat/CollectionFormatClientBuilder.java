...
public final class CollectionFormatClientBuilder
    ...
    @Metadata(generated = true)
    @Override
    public CollectionFormatClientBuilder httpPipeline(HttpPipeline pipeline) {
    ...
    private CollectionFormatClientImpl buildInnerClient() {
        ...
        CollectionFormatClientImpl client = new CollectionFormatClientImpl(localPipeline, localEndpoint);
        return client;
    }
