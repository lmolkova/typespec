...
public final class PathParametersSimpleExpansionStandardsImpl {
     ...
     */
    private final PathParametersSimpleExpansionStandardsService service;
    ...
    /**
     * Initializes an instance of PathParametersSimpleExpansionStandardsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    PathParametersSimpleExpansionStandardsImpl(RoutesClientImpl client) {
        this.service = RestProxy.create(PathParametersSimpleExpansionStandardsService.class, client.getHttpPipeline());
        this.client = client;
    }

    /**
     * The interface defining all the services for RoutesClientPathParametersSimpleExpansionStandards to be used by the
     * proxy service to perform REST calls.
     */
    @ServiceInterface(name = "RoutesClientPathPara", host = "{endpoint}")
    public interface PathParametersSimpleExpansionStandardsService {
        static PathParametersSimpleExpansionStandardsService getNewInstance(HttpPipeline pipeline,
            ObjectSerializer serializer) {
            try {
                Class<?> clazz
                    = Class.forName("routes.implementation.PathParametersSimpleExpansionStandardsServiceImpl");
                return (PathParametersSimpleExpansionStandardsService) clazz
