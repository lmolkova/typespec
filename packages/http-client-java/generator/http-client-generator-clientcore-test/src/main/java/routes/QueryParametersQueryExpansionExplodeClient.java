...
public final class QueryParametersQueryExpansionExplodeClient {
     ...
     */
    @Metadata(generated = true)
    QueryParametersQueryExpansionExplodeClient(QueryParametersQueryExpansionExplodesImpl serviceClient,
    ...
    public Response<Void> primitiveWithResponse(String param, RequestOptions requestOptions) {
        return this.instrumentation.instrument("Routes.QueryParameters.QueryExpansion.Explode.primitive",
    ...
    public Response<Void> arrayWithResponse(List<String> param, RequestOptions requestOptions) {
        return this.instrumentation.instrument("Routes.QueryParameters.QueryExpansion.Explode.array", requestOptions,
    ...
    public Response<Void> recordWithResponse(Map<String, Integer> param, RequestOptions requestOptions) {
        return this.instrumentation.instrument("Routes.QueryParameters.QueryExpansion.Explode.record", requestOptions,
