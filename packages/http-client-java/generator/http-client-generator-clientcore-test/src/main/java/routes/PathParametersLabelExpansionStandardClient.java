...
public final class PathParametersLabelExpansionStandardClient {
    ...
    public Response<Void> primitiveWithResponse(String param, RequestOptions requestOptions) {
        return this.instrumentation.instrument("Routes.PathParameters.LabelExpansion.Standard.primitive",
    ...
    public Response<Void> arrayWithResponse(List<String> param, RequestOptions requestOptions) {
        return this.instrumentation.instrument("Routes.PathParameters.LabelExpansion.Standard.array", requestOptions,
    ...
    public Response<Void> recordWithResponse(Map<String, Integer> param, RequestOptions requestOptions) {
        return this.instrumentation.instrument("Routes.PathParameters.LabelExpansion.Standard.record", requestOptions,
