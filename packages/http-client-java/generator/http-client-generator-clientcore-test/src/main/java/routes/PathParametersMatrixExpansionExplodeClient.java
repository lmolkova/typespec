...
import routes.implementation.PathParametersMatrixExpansionExplodesImpl;

/**
 * Initializes a new instance of the synchronous RoutesClient type.
 */
@ServiceClient(builder = RoutesClientBuilder.class)
public final class PathParametersMatrixExpansionExplodeClient {
    @Metadata(generated = true)
    private final PathParametersMatrixExpansionExplodesImpl serviceClient;

    private final Instrumentation instrumentation;

    /**
     * Initializes an instance of PathParametersMatrixExpansionExplodeClient class.
     * 
     * @param serviceClient the service client implementation.
     * @param instrumentation the instrumentation instance.
     */
    @Metadata(generated = true)
    PathParametersMatrixExpansionExplodeClient(PathParametersMatrixExpansionExplodesImpl serviceClient,
    ...
    public Response<Void> primitiveWithResponse(String param, RequestOptions requestOptions) {
        return this.instrumentation.instrument("Routes.PathParameters.MatrixExpansion.Explode.primitive",
    ...
    public Response<Void> arrayWithResponse(List<String> param, RequestOptions requestOptions) {
        return this.instrumentation.instrument("Routes.PathParameters.MatrixExpansion.Explode.array", requestOptions,
    ...
    public Response<Void> recordWithResponse(Map<String, Integer> param, RequestOptions requestOptions) {
        return this.instrumentation.instrument("Routes.PathParameters.MatrixExpansion.Explode.record", requestOptions,
